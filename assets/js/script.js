...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Priyanshu Kumar Saw";
...
var typed = new Typed(".typing-text", {
    strings: ["Data Analytics", "Machine Learning","Deep Learning", "frontend development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
// var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
// s1.async=true;
// s1.src='https://embed.tawk.to/65f354c19131ed19d979f910/1hov8658k';
// s1.charset='UTF-8';
// s1.setAttribute('crossorigin','*');
// s0.parentNode.insertBefore(s1,s0);
// })();
...
srtop.reveal('.abachievements .content .resumebtn', { delay: 200 });
